...
const Registration = () => {
  const { handleSignWithGoogle, setLoginUserInfo, setLoading } = useContext(
  ...
  return (
    <div className="mb-10">
      <div className="max-w-2xl mx-auto mt-7 bg-gray-100 border border-gray-200 rounded-xl shadow-2xs">
        <div className="p-4 sm:p-7">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-gray-600">
              ...
              <Link to="/login">
                <span className="text-blue-600 decoration-2 hover:underline focus:outline-hidden focus:underline font-medium">
                  Sign in here
                </span>
              </Link>
            </p>
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      placeholder="Name"
                      name="name"
                      className="py-2.5 sm:py-3 px-4 block w-full border border-gray-200 rounded-lg sm:text-sm outline-none bg-white"
                      required
                    />
                  </div>
                </div>
