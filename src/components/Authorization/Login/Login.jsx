...
const Login = () => {
  return (
    <div>
      <div className="m-7 text-center font-bold text-5xl uppercase">
        Just Login NOW
      </div>
      <div className="text-center">
        {/* Google */}
        <button className="btn bg-white text-black border-[#e5e5e5] text-2xl p-8">
          <svg
